...
function Player:updateFixed( g, dt)
	...
	if Spriter.ControllerPressed( "fire" )~=0 then
		...
		self.body:ApplyForceToCenter( -math.sin(a)*14, math.cos(a)*14 )
	end
...
function Game.preload()
	...
	Game.physicsWorldBody:AddSVGCollision( "land", "badland.svg", "", -640, -360 )
	...
	Game.landscape = SpriterSceneSVG:new( "badland.svg", "", -640, -360 )
	Game.layer0:AddChild( Game.landscape )
